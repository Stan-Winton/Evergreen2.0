...
final class Version20240322132009 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE categorias (id INT AUTO_INCREMENT NOT NULL, nombre VARCHAR(20) NOT NULL, tipo VARCHAR(20) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE pedidos ADD CONSTRAINT FK_6716CCAA55E03C89 FOREIGN KEY (comercios_id) REFERENCES comercios (id)');
        $this->addSql('ALTER TABLE pedidos ADD CONSTRAINT FK_6716CCAADB38439E FOREIGN KEY (usuario_id) REFERENCES usuario (id)');
        $this->addSql('ALTER TABLE productos ADD CONSTRAINT FK_767490E655E03C89 FOREIGN KEY (comercios_id) REFERENCES comercios (id)');
        $this->addSql('ALTER TABLE productos ADD CONSTRAINT FK_767490E63397707A FOREIGN KEY (categoria_id) REFERENCES categorias (id)');
        $this->addSql('ALTER TABLE productos_pedidos ADD CONSTRAINT FK_5F082DB5ED07566B FOREIGN KEY (productos_id) REFERENCES productos (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE productos_pedidos ADD CONSTRAINT FK_5F082DB5213530F2 FOREIGN KEY (pedidos_id) REFERENCES pedidos (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE usuario ADD CONSTRAINT FK_2265B05D55E03C89 FOREIGN KEY (comercios_id) REFERENCES comercios (id)');
        $this->addSql('ALTER TABLE valoraciones ADD CONSTRAINT FK_40850667ED07566B FOREIGN KEY (productos_id) REFERENCES productos (id)');
        $this->addSql('ALTER TABLE valoraciones ADD CONSTRAINT FK_40850667DB38439E FOREIGN KEY (usuario_id) REFERENCES usuario (id)');
    }
